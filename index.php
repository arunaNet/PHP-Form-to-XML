...
<head>
    <meta charset="UTF-8">
    <title>arunaNet - XML Datei aus Formular</title>
...
<body>
	<div class="container">
		<h2 class="display-4 pb-5 pt-5 text-center">HTML-Formular in XML-Datei speichern</h2>
		<form action="" method="post">
			...
			<div class="form-group">
				...
				<label class="form-check-label" for="opt-in">
                    <span class="req">PFLICHTFELD</span><br>Ich habe die Hinweise in der <a href="#">Datenschutzerkl&auml;rung</a> verstanden und stimme diesen hiermit zu.
				</label>
			</div>
            <?php
                error_reporting(0);
